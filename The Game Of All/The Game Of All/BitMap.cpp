...
void BitMap::Draw(HDC hdc, int x, int y, int sizeX, int sizeY)
{
...
void BitMap::Draw(HDC hdc, int x, int y, int sizeX, int sizeY, int offset, int max)
{
	TransparentBlt(hdc, x, y, sizeX * ((offset/max) * 0.01f), sizeY, m_hMemDC, 0, 0, m_MapSize.cx * ((offset / max) * 0.01f), m_MapSize.cy, RGB(255, 0, 255));
}
